...
function InstagramIcon() {
	return (
		<svg viewBox="0 0 24 24" className="size-4 fill-current" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
const socialLinks = [
	{ href: studioConfig.instagramUrl, label: "Instagram", Icon: InstagramIcon },
	{ href: studioConfig.facebookUrl, label: "Facebook", Icon: FacebookIcon },
	{ href: studioConfig.whatsappUrl, label: "WhatsApp", Icon: WhatsAppIcon },
];
							...
							{socialLinks.map(({ href, label, Icon }) => (
								<li key={label}>
									<Link
										...
										aria-label={label}
										className="border-border text-muted-foreground hover:text-foreground hover:border-foreground flex size-9 items-center justify-center rounded-full border transition-colors"
									>
										<Icon />
									</Link>
								</li>
